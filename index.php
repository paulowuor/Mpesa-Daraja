...
<head>
    ...
    <title>Lipa na Mpesa STK Push</title>
    <link
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" ">
  ...
  <body oncontextmenu="return false" class="snippet-body">
    ...
    <input type="text" class="form-control" name="amount" placeholder="Enter Amount" value="1" readonly>
</div>
                ...
                <div class="col-12">
                  <button type="submit" class="btn btn-success" name="submit" value="submit">Pay Your Order</button>
                </div>
              </form>
              <!--bs5 input-->
          </div>
